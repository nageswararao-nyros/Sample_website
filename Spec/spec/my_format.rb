    ...
    builder.testsuites do
      builder.testsuite  do
        ...
        @test_results.each do |test|
          builder.testcase  :name => test.metadata[:full_description], :time => test.metadata[:execution_result][:run_time], :file => test.metadata[:file_path], :assertion => test.metadata[:assertion] do
